...
namespace CourseWorkProject.Areas.Staff.Controllers
{
    ...
    public class MainController : Controller
    {
        ...
        {
            //var StudentList = db.Users.Where(h => h.Role.id == 1).ToList();
            //var myLects = db.Profiles.Where(h => h.User.Role.id == 2).ToList();

            //SelectList LectList = new SelectList(myLects, "Id", "Name");

            //ViewBag.Lect = LectList;
